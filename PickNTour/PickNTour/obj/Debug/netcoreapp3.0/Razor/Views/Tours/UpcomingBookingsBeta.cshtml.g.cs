#pragma checksum "C:\Users\Nick\Documents\GitHub\PickNTour\PickNTour\PickNTour\Views\Tours\UpcomingBookingsBeta.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "82a8e7ed88f2dabc8d1dad421fb4cd99974201ba"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"82a8e7ed88f2dabc8d1dad421fb4cd99974201ba", @"/Views/Tours/UpcomingBookingsBeta.cshtml")]
...
#line hidden
#nullable disable
            WriteLiteral("\r\n<h1>Your Upcoming Tours Beta</h1>\r\n\r\n<div id=\"bookings\"></div>\r\n\r\n\r\n");
                    ...
                    $.each(data, function(index, value) {
                        ...
                        cardBuilder += (
                            ...
                            '<div class=""card"" style=""width:400px"">' +
                               ");
                WriteLiteral(@"     '<img class=""card-img-top"" src=""/images/travel.jpg"">' +
                                    '<div class=""card-body"">' +
                                        ...
                                        '<p class=""card-text"">Date Booked: ' + moment(value.dateBooked).format('MMMM Do YYYY, h:mm:ss a') + ""</p");
                WriteLiteral(@">"" + '<hr/>' +
                                    ...
                                    '<div class=""card-footer"">' +
                                        ...
                                        ""<button class='btn btn-outline-danger js-cancel' style='margin:5px;' data-booking-id="" + value.id + "">Cancel Bookin");
            ...
            $(""#bookings"").on(""click"", "".js-cancel"", function () {
                ...
                bootbox.confirm(""Are you sure you want to cancel this booking?"", function (result) {
                    if (result) {
                        $.ajax({
                            url");
                WriteLiteral(@": ""/api/tours/"" + button.attr(""data-booking-id""),
                            method: ""DELETE"",
